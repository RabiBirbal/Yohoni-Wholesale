  ...
  <div class="row cloth-feature">
    ...
    <div class="col-md-3 items" style="margin-bottom: 30px;">
      <a href="{{asset('product/'.Str::slug($data['name']).'/id='.$data['id'])}}">
        @if($data->offer != null)
      <span class="badge" style="background-color: yellow; color: red; margin-left: 10%">{{$data->offer}}</span>
      @endif
      @if($data->product_quantity <= '0')
      <span class="badge" style="margin-left: 55%; background-color: red;">Out Of Stock</span>
      @else
      <span class="badge" style="margin-left: 65%; background-color: green;">In Stock</span>
      @endif
